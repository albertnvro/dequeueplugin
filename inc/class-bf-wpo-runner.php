...
class BF_WPO_Runner {
	...
	public function scripts_runner() {
		if ( is_admin() ) {
			return;
		}
	...
	/**
	 * Function that print style's handle list
	 */
	public function print_styles() {
		...
		if ( $wp_styles && current_user_can( 'administrator' ) ) {
			print '<div style="display: block; width: 100%; line-height: 2rem; padding: .3rem 1rem; background-color: #ccc; position:fixed; bottom:' . esc_html( $bottom ) . '; left:0; z-index: 999;">';
	...
	/**
	 * Function that print script's handle list
	 */
