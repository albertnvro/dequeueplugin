...
/**
 * Class which runs Dequeuer Admin's instance
 */
			...
			<form method="post" action="options.php">
				...
				<table class="form-table">
					...
					if ( $this->is_woocommerce_activated() ) {
						?>
						<tr valign="top">
							<th scope="row"><?php _e( 'Styles for Products', 'bf-wpo-dequeuer' ); ?></th>
							<td><textarea rows="5" cols="50" name="bf_wpo_scripts[styles-product]"><?php echo esc_attr( $bf_wpo_options['styles-product'] ); ?></textarea></td>
						</tr>
						<?php
					}
					?>
